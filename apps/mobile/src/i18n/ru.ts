...
export const ru = {
  ...
  // Профиль клиента (ТЗ §6.7). Данные из GET /me — только отображение; редактируем
  // лишь предпочтительный ПВЗ (PATCH /me/preferred-pvz). Список ПВЗ — публичный.
  profile: {
    title: 'Профиль',
    open: 'Профиль',
    phone: 'Телефон',
    room: 'Мой Room',
    pvz_section: 'Пункт выдачи',
    pvz_not_set: 'Не выбран',
    pvz_change: 'Изменить',
    pvz_updated: 'Пункт выдачи обновлён',
    pvz_select_title: 'Выберите пункт выдачи',
    pvz_empty: 'Нет доступных пунктов выдачи',
    pvz_error: 'Не удалось загрузить пункты выдачи',
